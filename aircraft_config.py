...
AIRCRAFT_CONFIG = {
    ...
    ('CJ2', 'Tamarack'): (274.3, 55.3, 0.8025, 3.5, 0, 0.72, 2, 0.851, 45000.0, 0.2, 4.5, 0.026311,
                          0.01, 0.015, 0.011, 0.017, 0.015, 0.25,
                          7805.0,   # ← BEW (7560 + 75) + 170 = 7805
                          10100, 12600.0, 12500.0,
    ...
    ('CJ3', 'Tamarack'): (304.0, 59.3, 0.8025, 4.5, 0, 0.72, 2, 1.0, 45000.0, 0.2, 4.5, 0.026378,
                          0.01, 0.015, 0.011, 0.017, 0.015, 0.25,
                          8405.0,   # ← BEW (8160 + 75) + 170 = 8405
                          10910, 14170.0, 14070.0,
    ...
    ('C208B', 'Flatwing'): (279.0, 52.1, 0.80, 0.0, 0, 0.30, 1, 1.00, 25000.0, 0.2, 4.5, 0.032,
                             0.010, 0.018, 0.030, 0.020, 0.03, 0.03,
                             4430.0,   # ← BEW 4260 + 170
                             7000.0, 8850.0, 8750.0,
    ...
    ('C208', 'Tamarack'): (299.2, 58.1, 0.84, 1.0, 0, 0.30, 1, 1.00, 25000.0, 0.2, 4.5, 0.031,
                            0.010, 0.018, 0.030, 0.020, 0.03, 0.03,
                            4600.0,   # ← BEW (4355 + 75) + 170 = 4600
                            7050.0, 8100.0, 8000.0,
                            2000.0, 15.0, 230.0, 0.55, 175.0, 1.6, 2.2, 2.7, 0.30, 110.0, 500, 0.50, 120.0)
}


# Turboprop engine/prop parameters per model (unchanged)
TURBOPROP_PARAMS = {
    'C208B': {
        'P_rated_shp': 675.0,
